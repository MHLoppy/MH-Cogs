...
# Rise of Nations - Rise of Babel taunts cog by MHLoppy
# based on code from hiback cog by Falcom
# https://github.com/nmbook/FalcomBot-cogs/tree/master/hiback

import discord
from redbot.core import commands
import asyncio

class RonRobTauntsFallback(commands.Cog):
    """asf."""
    def __init__(self, bot):
        """Initialize RoN RoB Taunts (Fallback) cog."""
        self.bot = bot
    ...
    async def on_message_without_command(self, message):
        ...
        if content.isdigit():
            taunt = await self.taunt_list(int(content))
            
            # We give Dyno a brief chance to respond first
            asyncio.sleep(1)
            
            try:
                taunt = await self.taunt_list(int(content))
                bot_message = await message.channel.send(taunt)

                # Define the check function for monitoring messages
                def check(msg):
                    return (
                ...
                # Wait for a message that matches the check for 5 seconds
                try:
                    await self.bot.wait_for('message', timeout=5.0, check=check)
                    # If a matching message is found, delete the bot's message
                    await bot_message.delete()
                except asyncio.TimeoutError:
                    # If no matching message is found, do nothing
                    pass
    ...
    async def taunt_list(self, number: int):#this would make a little more sense as an external file to import, but that's an extra step to learn to do
        """
        Dictionary lookup of RoB taunts.
        """
        switch={
          1:'Yes.',
          2:'No.',
          ...
          26:'Wanna ally?',
          27:'Wanna make peace?',
          28:'Of course you realize, this means war...',
          29:'Pay up or die.',
          30:'Prepare to be crushed.',
          31:'Who we gonna attack?',
          ...
          160:'Rock and Roll!!! I attack all who dare to face me #ICON55',
          ...
          165:'I think, I like this city, We\'re taking this place over...',
          ...
          178:'Help, I need somebody, Help, not just anybody, Help, you know I need someone, help!!!',
          179:'Help me if you can, I\'m feeling down... And I do appreciate you being round...',
          180:'Help me, get my feet back on the ground... Won\'t you please, please help me?!?',
          ...
          191:'Shit... This game is laggy...#ICON58',
          192:'Please all turn off other programs running in the background... please!',
          193:'It\'s GameSpy again...',
          194:'Man... This tauntpack sucks...',
          ...
          199:'Hmmm unprocessed FishSticks...',
          ...
          226:'You\'d need three promotions to get to be an asshole.',
          227:'Disappointed!!!',
          228:'Assholemioooo!!!!',
          ...
          303:'Have you lost your fucking mind?',
          304:'He\'s full of shit!',
          305:'I warned you, you fat piece of shit!',
          306:'*CRAZY LAUGHTER*',
          ...
          322:'_FSF_[PL]Muad\'Dib: "This is paradise, this town is like a great big pussy, Just waiting to get fucked".',
          323:'_FSF_Zornmeister is in da House!!!',
          324:'_FSF_Godfather: "If anything in this life is certain, if history has thaught us anything... \'t is that you could kill anyone".',
          ...
          361:'God damn it. Can we please just get back to playing our videogame, please?!',
          ...
          390:'Once again our reputation precedes us.',
          ...
          414:'I farted, it\'s wet and I don\'t wanna move',
          ...
          424:'Oh, take it easy, will ya? Come on, be nice. For you, I\'m doing this show straight. No booze, no pot, no coke, no nothing... Oh, god. Oh, don\'t get me wrong, really. I don\'t snort cocaine. I just like the way it smells, that\'s all.',
          425:'But I am stoned!',
          ...
          445:'Please, please don\'t push the button, you have no idea what it... ...does',
          ...
          454:'What the fuck is the internet? –The internet is a communications tool used the world over where people can come together to bitch about movies and share pornography with one another.',
          455:'It\'s alive!',
          ...
          498:'We are advancing constantly and we\'re not interested in holding onto anything except the enemy! We\'re going to hold onto him by the nose and kick him in the ass! ..And we\'re going to go through him like crap through a goose!',
          ...
          517:'We interrupt our program to bring you a special broadcast. The German news agency Transoceanic said today in a broadcast that the Allied invasion had begun. There was no Allied confirmation.',
          ...
          522:'Important assignment!  Important assignment!',
          ...
          608:'One minute to autodestruct…',
          609:'Auto-shutdown sequence in progress...',
          ...
          618:'What a filthy job! –Could be worse. –How? –Could be raining...',
          ...
          621:'You maniacs! You blew it up! Oh, damn you! God damn you all to hell!',
          ...
          652:'Oh, Shit fire and fuck me running!',
          653:'Always hurting me...',
          654:'You hurt me!',
          655:'Damn, reckon I\'m up shit creek now!',
          ...
          687:'Oh, goody, My Illudium Pu–36 Explosive Space Modulator!',
          ...
          691:'Well, heh heh, looks like we\'re, heh heh heh, looks like we\'re shy one horse.',
          ...
          695:'You\'re an asshole, you\'re an asshole, and you\'re an asshole.',
          696:'Fuck you. Fuck you. Fuck you. You\'re cool. And fuck you!',
          697:'Where\'s my bourbon?',
          698:'Why don\'t ya cheer Bitch!',
          699:'Die neighbor!',
          ...
          716:'I bet this place is just crawling with their damn shit monkeys.',
          ...
          724:'We don’t take no shit from no suckers!',
          725:'I\'m on you like stink on shit!',
          ...
          734:'Losers always whine about \'their best\'. Winners go home and fuck the prom queen.',
          735:'Are you going to pull those pistols or whistle Dixie?',
          736:'So, how did you do, pussy-boy?',
          ...
          742:'Oh, son–of–a–b–b–– son–of–a–b–b–– son–of–a–b–b–– uh, gun. Heh, heh, heh. You thought I was going to, uh, say son–of–a–bitch, didn\'t you? Heh, heh.',
          743:'Your next!',
          744:'Bloody Hell!',
          ...
          762:'You\'re a sucker!!! ',
          763:'Are you blackmailing me, you ambitious shit?',
          764:'As if we care.',
          ...
          774:'Don’t fuck with me fellows!',
          ...
          783:'Personally, I think you\'re a fucking idiot.',
          784:'X\'squeeze me.',
          ...
          820:'I am ‘The Law’!',
          821:'It’s a lie…the evidence have been falsified. I never broke the law, I am the law!',
          822:'What the hell are you talking about?!?',
          823:'What was that?!?',
          824:'Who gives a shit?!?',
          ...
          879:'Do you want MoR?!? Check out: https://morleague.com',
          880:'Hello, we’re your new neighbours, don’t be alarmed, we’re Negroes.',
          881:'Y’all want something',
          882:'What the fuck’s going on here',
          883:'Who the fuck are you, what you doing here',
          884:'I got a power ranger stuck up my ass',
          885:'You two motherfuckers need Jesus ………. Cover your ears baby',
          886:'Bottom line, I will knock you the fuck out',
          ...
          891:'Freeze mother bitches! …. Don’t you move',
          ...
          935:'Let\'s see how you like my cock rocket ... COCK ROCKET!!! ',
          ...
          938:'That\'s right. It\'s war once again... We are fighting an enemy like we have never encountered before. They\'re evil beyond reproach. Where they\'ve come from? I don\'t know. We need to send them back to wherever it was.',
          ...
          961:'Mememememe... I am the Great Mighty Poo and I\'m going to throw my shit at you. A huge supply of tish come from my chocolate starfish. How about some scat, you little twat?',
          ...
          964:'America, fuck yeah! Coming again to save the motherfucking day, yeah!',
          ...
          975:'This is Man versus Vegetable. - Technically sir, tomatoes are fags. He means fruits. Ahh fruits... See what I mean....',
